...
def main():
    from Preppers.Population import ex_seg_sites#, transpose_list_of_lists, genotypes
    from Parsers.SeqIO import PhylipReader
    phy = PhylipReader("/home/jamc/Data/GitHub/PopPyGen/Data/sback.phy")
    out = open("/home/jamc/Data/GitHub/PopPyGen/Data/sback_snps.phy", "w")
